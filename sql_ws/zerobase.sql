...
INSERT INTO `celeb` VALUES (1,'아이유','1993-05-16',29,'F','가수, 탤런트','EDAM엔터테인먼트'),(2,'이미주','1994-09-23',28,'F','가수','울림엔터테인먼트'),(3,'송강','1994-04-23',28,'M','탤런트','나무엑터스'),(4,'강동원','1981-01-18',41,'M','영화배우, 탤런트','YG엔터테인먼트'),(5,'유재석','1972-08-14',50,'M','MC, 개그맨','안테나'),(6,'차승원','1970-06-07',52,'M','영화배우, 모델','YG엔터테인먼트'),(7,'이수현','1999-05-04',23,'F','가수','YG엔터테인먼트');
...
-- Dump completed on 2024-03-29 22:02:49
